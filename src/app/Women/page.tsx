...
//           <div key={product.id} className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 hover:shadow-xl transition-transform duration-300 ease-in-out">
//             <img src={product.image} alt={product.name} className="h-60 w-full object-cover rounded-t-lg" />
//             <div className="p-6">
...
//               <button onClick={() => handleAddToCart(product)} className="mt-4 w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition duration-300 flex items-center justify-center space-x-2">
...
//           </div>
//           <button onClick={() => setIsCheckoutOpen(true)} className="mt-4 w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition duration-300">Proceed to Checkout</button>
//         </div>
//       )}

//       <Dialog open={isCheckoutOpen} onClose={() => setIsCheckoutOpen(false)} className="fixed inset-0 flex items-center justify-center p-4 bg-gray-900 bg-opacity-50">
//         <div className="bg-white p-6 rounded-lg shadow-xl max-w-md">
//           <h2 className="text-2xl font-bold mb-4">Checkout</h2>
//           <form onSubmit={handleCheckout}>
//             <input type="text" placeholder="Full Name" required className="w-full p-2 border rounded mb-4" />
//             <input type="email" placeholder="Email Address" required className="w-full p-2 border rounded mb-4" />
//             <input type="text" placeholder="Shipping Address" required className="w-full p-2 border rounded mb-4" />
//             <button type="submit" className="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition duration-300">Confirm Order</button>
//           </form>
//         </div>
//       </Dialog>
